...
@Component({
  selector: 'app-homepage-editor-component-carousel-dialog',
  imports: [
    ReactiveFormsModule,
    MatFormFieldModule,
    MatInputModule,
  ...
  templateUrl: './homepage-editor-component-carousel-dialog.component.html',
  styleUrl: './homepage-editor-component-carousel-dialog.component.scss',
})
export class HomepageEditorComponentCarouselDialogComponent implements OnInit {
  public component: ComponentInstance = inject(MAT_DIALOG_DATA);
  private dialogRef = inject(
    MatDialogRef<HomepageEditorComponentCarouselDialogComponent>,
  );
